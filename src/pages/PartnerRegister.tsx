...
export default function PartnerRegister() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Email verification is community-only (/member/register); partners are not gated on verify here.
            ...
            <div className="flex-1 bg-background/50 p-8 md:p-16 lg:p-24 overflow-y-auto relative">
                ...
                <div className="max-w-3xl mx-auto space-y-12 relative z-10">
                    <div className="text-center space-y-2 mb-2">
                        <h2 className="text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground">Discover, Connect & Collaborate</h2>
