        ...
        <div className="min-h-screen bg-background flex flex-col">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-8 flex flex-col md:flex-row gap-4">
                        <div className="relative flex-1 max-w-xl">
                            ...
                            <Input
                                className="pl-10 h-12 bg-foreground/5 border-foreground/10 text-base rounded-full"
            ...
            <div className="container mx-auto px-4 mt-8 flex-1">
                <Tabs value={currentTab} className="w-full">
                    <TabsList className="bg-foreground/5 border border-foreground/10 mb-8 p-1 rounded-full w-full justify-start overflow-x-auto h-auto">
                ...
                {loading ? (
                    ...
                    <div className="flex-1 flex items-center justify-center p-24 text-muted-foreground bg-foreground/5 border border-foreground/10 rounded-xl my-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-24">
                        {data.map((item, i) => {
                            ...
                            return (
                                <div key={item.id} onClick={() => setSelectedProfile(item)} className="group rounded-xl border border-foreground/10 bg-foreground/5 hover:bg-foreground/10 transition-colors cursor-pointer overflow-hidden flex flex-col">
