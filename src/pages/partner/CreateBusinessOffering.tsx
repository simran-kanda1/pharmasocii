                ...
                <Card className="bg-white/5 border-white/10 backdrop-blur-md shadow-2xl">
                    <CardHeader className="pb-8 border-b border-white/5">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <CardTitle className="text-3xl text-white">Create Business Offering</CardTitle>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <Label htmlFor="bioSafetyLevel" className="text-white/80">Bio Safety Level (BSL)</Label>
                                    <Input id="bioSafetyLevel" placeholder="e.g. BSL-1, BSL-2" value={formData.bioSafetyLevel} onChange={handleChange} className="h-12 bg-black/40 border-white/10 focus-visible:ring-primary/50 text-white" />
                                    <p className="text-xs text-muted-foreground">Highest clearance you operate at</p>
                                </div>
                                <div className="space-y-3">
                                    <Label htmlFor="certifications" className="text-white/80">Certifications</Label>
                                    <Input id="certifications" placeholder="e.g. ISO 9001, GMP, FDA Approved" value={formData.certifications} onChange={handleChange} className="h-12 bg-black/40 border-white/10 focus-visible:ring-primary/50 text-white" />
                                    <p className="text-xs text-muted-foreground">List all valid regulatory auths</p>
                                </div>
                                <div className="space-y-3">
                                    <Label htmlFor="serviceRegions" className="text-white/80">Service Region(s)</Label>
                                    <Input id="serviceRegions" placeholder="e.g. North America, Europe, Asia Pacific" value={formData.serviceRegions} onChange={handleChange} className="h-12 bg-black/40 border-white/10 focus-visible:ring-primary/50 text-white" />
                                    <p className="text-xs text-muted-foreground">Macro geographical footprint</p>
                                </div>
                                <div className="space-y-3">
                                    <Label htmlFor="serviceCountries" className="text-white/80">Service Countries</Label>
                                    <Input id="serviceCountries" placeholder="e.g. United States, Canada, Germany" value={formData.serviceCountries} onChange={handleChange} className="h-12 bg-black/40 border-white/10 focus-visible:ring-primary/50 text-white" />
                                    <p className="text-xs text-muted-foreground">Exact operational countries</p>
                                </div>
                                <div className="space-y-3 md:col-span-2">
                                    <Label htmlFor="categories" className="text-white/80">Listing Categories</Label>
                                    <Input id="categories" placeholder="e.g. Artificial Intelligence, Bioinformatics, Automation" value={formData.categories} onChange={handleChange} className="h-12 bg-black/40 border-white/10 focus-visible:ring-primary/50 text-white" />
