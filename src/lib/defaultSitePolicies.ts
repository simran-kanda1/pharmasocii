...
- Member Accounts (Community): Required to participate in the community. Anonymous usernames are permitted. Each individual may maintain only one Member Account, which is personal and non-transferable. You are solely responsible for safeguarding your login credentials and all activity under your account.
- Partner Accounts (Marketplace): Required to post business listings, services, jobs, events, or other marketplace content. May be created by or on behalf of a company or individual professional. Partner Accounts do not replace or substitute Member Accounts.
You must be at least the age of majority in your jurisdiction to create any account.
...
You agree to comply with our Community Guidelines. You must not post false/misleading information, off-label promotion, confidential data, or abusive material.

5. Marketplace & Posting Features
...
- User-Generated Content: Posts, comments, discussions, and other contributions on the Platform.
- Profile & Marketplace Information: Organizational details, service categories, and operational region details.
- Technical & Usage Information: Device data, IP address, browser type, operating system, and cookie data.

2. How We Use Your Information
- Operate, maintain, and improve features of the Platform.
- Manage user accounts and community engagement.
...
We do not sell or trade your personal information. We share information only with trusted service providers who perform business functions on our behalf, or where required by law.

4. Your Choices & Rights
You have the right to access, correct, or request deletion of your personal data. Contact us at info@pharmasocii.com to exercise these rights.
...
2. Sharing Resources & Expertise
Members are encouraged to share constructive resources and professional insights. Avoid speculation or misleading claims.

3. No Medical or Legal Advice
Do not provide medical or legal advice on this Platform. Content should never substitute for professional consultation.

4. Intellectual Property & Confidentiality
Do not post confidential or proprietary information belonging to yourself, your employer, or any third party.

5. No Commercial Promotions in Community
The community is not a forum for direct advertising, recruitment, or marketing. Spam and bulk messaging are strictly prohibited.
